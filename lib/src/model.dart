...
class AirdropPool {
  ...
  static AirdropPool unpack(List<int> data) {
    ...
    return AirdropPool(
      ...
      accountNonce: data.sublist(64, 68),
...
class AirdropPoolInstructionInitialize extends AirdropPoolInstruction {
  ...
  List<int> pack() {
    ...
    result.addAll(
        List.filled(AirdropPoolInstruction.packedSize - result.length, 0));
    return result;
  }
}
...
class AirdropPoolInstructionClaim extends AirdropPoolInstruction {
  ...
  List<int> pack() {
    final result = [
      1,
      (referrerWallet == null) ? 0 : 1,
      ...(referrerWallet ?? List.generate(32, (e) => 0))
    ];
    assert(result.length == AirdropPoolInstruction.packedSize);
    return result;
  }
